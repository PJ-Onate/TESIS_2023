...
#root.state('zoomed')
testWidget = fast.Page(root, root) #una instancia de la clase Page, con parámetros root, la ventana que se acaba de crear.Page hereda elementos de un widget Frane, y se lemañaden algunos elementos más en la  definición de clase
